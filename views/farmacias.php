...
<body>
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="col-md-12 ">
                <div class="h-40 p-5 bg-light border rounded-3 me-2">
                    <h2>Farmácias</h2>
                    <p>Rede LVD conta com 18 lojas, sendo 6 lojas na cidade de Camaquã/RS, 1 em Cristal/RS, 6 em Pelotas/RS,
                        1
                        em
                        Chuvisca/RS e 4 lojas na cidade de Rio Grande/RS.</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-sm-6">
                <div class="card-group mb-4  me-2 ">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Rede LVD - Loja 03</h5>
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av. Presidente Vargas, 409 - Centro Camaquã/RS</p>
                            <br>
                            <p class="card-text"><small class="text-muted">Fone: (51) 3692-1010 <br>
                ...
                <div class="card-group  mb-4 me-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av. Olavo de Moraes, 1133 - Centro Camaquã/RS</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Rede LVD - Loja 05</h5>
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av. Presidente Vargas, 739 - Centro Camaquã/RS</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av. Julio de Castilhos, 499 - Centro Camaquã/RS</p>
                ...
                <div class="card-group  mb-4 me-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av. Marechal Deodoro, 552 - Centro Pelotas/RS</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Rede LVD - Loja 08</h5>
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av. Domingos de Almeida, 1830 - Areal Pelotas/RS</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av. Marechal Deodoro, 1099 - Centro Pelotas/RS</p>
                            <p class="card-text"><small class="text-muted">
                ...
                <div class="card-group  mb-4 me-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Rua Cruz Alta, 985 - Viégas Camaquã/RS</p>
                            <br>
                ...
                <div class="card-group  mb-4 me-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av.Fernando Osório, 2200 - Posto Três Bicos Sala 02 - Três Vendas
                                Pelotas/RS</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Rua Marechal Floriano Peixoto, 359 - Centro Rio Grande/RS</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Av. Cidade de Pelotas, 194 -
                                Cidade Nova Rio Grande/RS</p>
                ...
                <div class="card-group  mb-4 me-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Rua Luiz Lorea, 492 - Centro
                                Rio Grande/RS</p>
                            <br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"><i class="fa-solid fa-location-dot me-2"></i>Rua Aquibadan, 656 - Centro
                                Rio Grande/RS</p>
                            <br>
